...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            // Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° big ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸
            loadinggif: '', // ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ° Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°ÐµÐ¼Ð°Ñ Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ big Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ
            loadopacity: 0.1, // Ð¿Ñ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ñ„Ð¾Ð½Ð° Ð¿ÐµÑ€ÐµÐºÑ€Ñ‹Ñ‚Ð¸Ñ tmb ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ	big Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ
            loadbackground: '#878787', // Ñ†Ð²ÐµÑ‚ Ñ„Ð¾Ð½Ð° Ð¿ÐµÑ€ÐµÐºÑ€Ñ‹Ñ‚Ð¸Ñ tmb ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ	 big Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ


            // Ð»ÑƒÐ¿Ð° (cursorshade)
            cursorshade: true, // Ð¿Ð¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ Ð»ÑƒÐ¿Ñ‹
            magnifycursor: 'crosshair', // Ð²Ð¸Ð´ ÐºÑƒÑ€ÑÐ¾Ñ€Ð° Ð¼Ñ‹ÑˆÐ¸ Ð½Ð°Ð´ tmb Ð² Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ðµ CSS
            cursorshadecolor: '#fff', // Ñ†Ð²ÐµÑ‚ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð»ÑƒÐ¿Ñ‹ Ð² Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ðµ CSS
            cursorshadeopacity: 0.3, // Ð¿Ñ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð»ÑƒÐ¿Ñ‹
            cursorshadeborder: '1px solid black', // Ð²Ð½ÐµÑˆÐ½Ð¸Ð¹ Ð±Ð¾Ñ€Ð´ÑŽÑ€Ð° ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð»ÑƒÐ¿Ñ‹ Ð² Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ðµ CSS
            zindex: '', // z-index ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð»ÑƒÐ¿Ñ‹ 
            stepzoom: 0.5, // ÑˆÐ°Ð³ Ð·ÑƒÐ¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ Ð¿Ñ€Ð¸ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐµ ÐºÐ¾Ð»ÐµÑÐ° Ð¼Ñ‹ÑˆÐ¸					
            zoomrange: [2, 2], // Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð·ÑƒÐ¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ
            zoomstart: 2, // ÑÑ‚Ð°Ñ€Ñ‚Ð¾Ð²Ð°Ñ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÐ° Ð·ÑƒÐ¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ
            disablewheel: true, // Ð¾Ñ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÑƒ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð° ÐºÐ¾Ð»ÐµÑÐ¾Ð¼ Ð¼Ñ‹ÑˆÐ¸ ÐºÐ¾Ð³Ð´Ð° ÐºÑƒÑ€ÑÐ¾Ñ€ Ð½Ð°Ð´ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¾Ð¹ tmb Ð² ÑÐ»ÑƒÑ‡Ð°Ðµ ÐµÑÐ»Ð¸ Ð½Ðµ Ð·Ð°Ð´Ð°Ð½ Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð·ÑƒÐ¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ


            // Ð¿Ð¾Ð´ÑÐºÐ°Ð·ÐºÐ° (statusdiv)
            showstatus: true, // Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¿Ñ€Ð¸ Ð½Ð°Ð²ÐµÐ´ÐµÐ½Ð¸Ð¸ Ð½Ð° tmb help ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€
            showstatustime: 2000, // Ð²Ñ€ÐµÐ¼Ñ Ð¿Ð¾ÐºÐ°Ð·Ð° help ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð°
            ...
            // ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ big ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ (magnifier)
            magnifierpos: 'right', // ÑÑ‚Ð¾Ñ€Ð¾Ð½Ð° Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° left/right
            magnifiersize: [0, 0], // Ñ€Ð°Ð·Ð¼ÐµÑ€ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð°  
            magnifiereffectanimate: 'showIn', // ÑÑ„Ñ„ÐµÐºÑ‚ Ð¿Ð¾ÑÐ²Ð»ÐµÐ½Ð¸Ñ/ÑÐºÑ€Ñ‹Ñ‚Ð¸Ñ fadeIn/showIn/slideIn
            innerzoom: false, // Ð¿Ð¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ Ð²Ð½ÑƒÑ‚Ñ€Ð¸ tmb
            innerzoommagnifier: false, // Ð¿Ð¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ ÐºÐ°Ðº Ð»ÑƒÐ¿Ñƒ
            descarea: false, // Ð¿Ð¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ Ð² Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð»ÑŒÐ½Ð¾Ð¹ Ð¾Ð±Ð»Ð°ÑÑ‚Ð¸, Ð¾Ð±Ð»Ð°ÑÑ‚ÑŒ descarea Ð´Ð¾Ð»Ð¶Ð½Ð° Ð¸Ð¼ÐµÑ‚ÑŒ width Ð¸ height				
            leftoffset: 15, // Ð¾Ñ‚ÑÑ‚ÑƒÐ¿ ÑÐ»ÐµÐ²Ð° Ð¾Ñ‚ tmb ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸
            rightoffset: 15, // Ð¾Ñ‚ÑÑ‚ÑƒÐ¿ ÑÐ¿Ñ€Ð°Ð²Ð° Ð¾Ñ‚ tmb ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸
            switchsides: true, // ÑƒÑ‡Ð¸Ñ‚Ñ‹Ð²Ð°Ñ‚ÑŒ ÐºÑ€Ð°Ð¹ ÑÐºÑ€Ð°Ð½Ð°
            magnifierborder: '1px solid black', // Ð²Ð½ÐµÑˆÐ½Ð¸Ð¹ Ð±Ð¾Ñ€Ð´ÑŽÑ€


            // ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ Ñ‚ÐµÐºÑÑ‚Ð° ÑÐ½Ð¸Ð·Ñƒ Ðº ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐµ
            textdnbackground: '#fff',
            textdnpadding: '10px',
            textdnfont: '13px/20px cursive',


            // ÐºÐ¾ÑÑ„Ñ„Ð¸Ñ†Ð¸ÐµÐ½Ñ‚Ñ‹ ÑÐºÐ¾Ñ€Ð¾ÑÑ‚Ð¸ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ð¸
            scrollspeedanimate: 5 /*4*/ , // Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ¸ big ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸
            zoomspeedanimate: 7, // Ð·ÑƒÐ¼Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ (Ð¿Ð»Ð°Ð²Ð½Ð¾ÑÑ‚ÑŒ)
            loopspeedanimate: 2.5 /*2.45342*/ , // Ð¿ÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ñ Ð¾Ð±Ð»Ð°ÑÑ‚Ð¸ Ð»ÑƒÐ¿Ñ‹ Ð¸ big ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð² Ñ€ÐµÐ¶Ð¸Ð¼Ðµ Ð»ÑƒÐ¿Ñ‹				
            magnifierspeedanimate: 350, // Ð¿Ð¾ÐºÐ°Ð·Ð° big ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð°
